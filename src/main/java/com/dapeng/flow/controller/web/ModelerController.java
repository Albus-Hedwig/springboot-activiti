package com.dapeng.flow.controller.web;
...
/**
 * 流程控制器
 * @date  2019年3月7日下午3:28:14
 * @author Administrator
 */
@Controller
@Api(value = "Model", tags = {"流程设计器web"})
public class ModelerController {
	...
	@ApiOperation(value = "发布流程模板", produces = "application/json")
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/revokePublish",method = RequestMethod.GET)
	@ApiOperation(value = "撤销流程定义", produces = "application/json")
	...
	@ApiOperation(value = "删除流程定义", produces = "application/json")
